...
async def backfill(kode_list: list[str] | None = None, limit: int | None = None) -> None:
    ...
    """
    # 1. Ambil daftar saham dari DB (default: IDX saja, karena XBRL adalah sumber
    #    laporan keuangan khusus emiten IDX — tidak relevan untuk saham NASDAQ/ETF)
    async with async_session() as session:
        ...
        if kode_list:
            ...
            stmt = stmt.where(Saham.market == "IDX")
